...
@endpush
    ...
    <script type="text/javascript" src={{asset("/assets/plugins/jqwidgets/jqxtree.js")}}></script>
  	...
  	<script type="text/javascript" src={{asset("/assets/scripts/modules/framework/master.js")}}></script>
     ...
     <div class="main-card mb-3 card" id = "maincard">
        ...
        <div class="card-body">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane mol-tab-pane active" id="tab-detail" role="tabpanel">
