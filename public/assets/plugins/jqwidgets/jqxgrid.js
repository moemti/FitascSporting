...
(function(b) {
    ...
    b.extend(b.jqx._jqxGrid.prototype, {
        ...
        _updatesize: function(q, g) {
            ...
            var h = 5;
            l.resizingGrid = true;
            if (b.jqx.isHidden(l.host)) {
                return
            }
            if (l.editcell) {
                l.endcelledit(l.editcell.row, l.editcell.column, true, true);
                l._oldselectedcell = null
            }
            if (d != l._oldHeight || g == true) {
                var e = l.groupable && l.groups.length > 0;
                var m = l.vScrollBar.css("visibility");
                if (!l.autoheight) {
                    if (l.virtualmode) {
                        l._pageviews = new Array()
                    }
                    if (!e && !l.rowdetails && !l.pageable) {
                        l._arrange();
                        l.virtualsizeinfo = l._calculatevirtualheight();
                        var d = Math.round(l.host.height()) + 2 * l.rowsheight;
                        if (parseInt(d) >= parseInt(l._oldHeight)) {
                            l.prerenderrequired = true
                        }
                        l._renderrows(l.virtualsizeinfo);
                        if (l.rtl) {
                            l._updatecolumnwidths();
                            if (l.table) {
                                l.table.width(l.columnsheader.width())
                            }
                            l._updatecellwidths()
                        }
                    } else {
                        ...
                        l.prerenderrequired = true;
                        var d = Math.round(l.host.height()) + 2 * l.rowsheight;
                        realheight = l._gettableheight();
                        var p = Math.round(d / l.rowsheight);
                        var i = Math.max(l.dataview.totalrows, l.dataview.totalrecords);
                        if (l.pageable) {
                            i = l.pagesize;
                            if (l.pagesize > Math.max(l.dataview.totalrows, l.dataview.totalrecords) && l.autoheight) {
                                i = Math.max(l.dataview.totalrows, l.dataview.totalrecords)
                            } else {
                                if (!l.autoheight) {
                                    if (l.dataview.totalrows < l.pagesize) {
                                        i = Math.max(l.dataview.totalrows, l.dataview.totalrecords)
                                    }
                                }
                            }
                        }
                        var k = i * l.rowsheight;
                        var f = l._getpagesize();
                        if (!l.pageable && l.autoheight) {
                            p = i
                        }
                        if (l.virtualsizeinfo) {
                            l.virtualsizeinfo.visiblerecords = p
                        }
                        l.rendergridcontent(true, false);
                        l._renderrows(l.virtualsizeinfo)
                    }
                    if (m != l.vScrollBar.css("visibility")) {
                        l.vScrollInstance.setPosition(0);
                        l._arrange();
                        l._updatecolumnwidths();
                        if (l.table) {
                            l.table.width(l.columnsheader.width())
            ...
            if (o != l._oldWidth || q == true) {
                var n = false;
                if (l.editcell && l.editcell.editor) {
                    switch (l.editcell.columntype) {
                        case "dropdownlist":
                            n = l.editcell.editor.jqxDropDownList("isOpened") || (l.editcell.editor.jqxDropDownList("isanimating") && !l.editcell.editor.jqxDropDownList("ishiding"));
                            if (n) {
                                l.editcell.editor.jqxDropDownList({
                                    openDelay: 0
                                });
                                l.editcell.editor.jqxDropDownList("open");
                                l.editcell.editor.jqxDropDownList({
                                    openDelay: 250
                                });
                                return
                            ...
                            break;
                        case "combobox":
                            n = l.editcell.editor.jqxComboBox("isOpened") || (l.editcell.editor.jqxComboBox("isanimating") && !l.editcell.editor.jqxComboBox("ishiding"));
                            if (n) {
                                l.editcell.editor.jqxComboBox({
                                    openDelay: 0
                                });
                                l.editcell.editor.jqxComboBox("open");
                                l.editcell.editor.jqxComboBox({
                                    openDelay: 250
                                });
                                return
                        ...
                        case "datetimeinput":
                            if (n) {
                                n = l.editcell.editor.jqxDateTimeInput("isOpened") || (l.editcell.editor.jqxDateTimeInput("isanimating") && !l.editcell.editor.jqxDateTimeInput("ishiding"));
                                l.editcell.editor.jqxDateTimeInput({
                                    openDelay: 0
                                });
                                l.editcell.editor.jqxDateTimeInput("open");
                                l.editcell.editor.jqxDateTimeInput({
                                    openDelay: 250
                                });
                                return
                ...
                var j = l.hScrollBar.css("visibility");
                l._arrange();
                l._updatecolumnwidths();
                if (l.table) {
                    l.table.width(l.columnsheader.width())
                ...
                l._updatecellwidths();
                if (!(q == false && l._oldWidth > o)) {
                    if (!g || l.dataview.rows.length == 0) {
                        l._renderrows(l.virtualsizeinfo)
                    }
                }
                if (j != l.hScrollBar.css("visibility")) {
                    l.hScrollInstance.setPosition(0)
                }
            }
            l._oldWidth = o;
            l._oldHeight = d;
            l.resizingGrid = false
        },
        ...
        _rendercolumnheaders: function() {
            ...
            b.each(this.columns.records, function(W, U) {
                ...
                var ab = function(ai, ad, aj) {
                    if (ai.selectable) {
                        var al = x.getrows();
                        if (ai.selected === undefined) {
                            ai.selected = false
                        }
                        if (!ad.shiftKey || x._clickedcolumn === undefined) {
                            x._clickedcolumn = ai
                        }
                        if (ad.shiftKey && x._clickedcolumn && aj === undefined) {
                            var ak = x.columns.records.indexOf(x._clickedcolumn);
                            var ah = x.columns.records.indexOf(ai);
                            var ae = Math.min(ak, ah);
                            var af = Math.max(ak, ah);
                            x.clearselection();
                            for (var ag = ae; ag <= af; ag++) {
                                ab(x.columns.records[ag], ad, true)
                            }
                        ...
                        for (var ag = 0; ag < al.length; ag++) {
                            x._applycellselection(al[ag].boundindex, ai.displayfield, ai.selected, false)
                        }
                        if (ai.selected) {
                            ai.element.setAttribute("selected", "")
                        } else {
                            ai.element.removeAttribute("selected")
                        }
                        ai._applyStyle();
                        if (aj === undefined) {
                            x._renderrows(this.virtualsizeinfo)
                ...
                if (Z.resizable && x.columnsresize && !V) {
                    ...
                    x.addHandler(H, j, function(ad) {
                        var i = parseInt(ad.pageX);
                        var af = 5;
                        var ai = parseInt(H.coord().left);
                        if (x.hasTransform) {
                            ai = b.jqx.utilities.getOffset(H).left
                        }
                        if (x.resizing) {
                            return true
                        }
        ...
        setcellvalue: function(o, F, H, Q, j) {
            ...
            if (C != null && C[F] !== H) {
                ...
                // TIBI
                var A = this.source && this.source._source && this.source._source.localdata && this.source._source.localdata.name === "observableArray";
    ...
    b.jqx.dataview = function() {
        ...
        this.refresh = function(m) {
            ...
            if (this.filters.length > 0 && !this.virtualmode) {
                ...
                if (this.source != null && this.source.filter != undefined && this.source.localdata != undefined) {
                    ...
                    if (this.source.filter == null || this.source.filter == undefined) {
                        for (var l = 0; l < f; l++) {
                            ...
                            var v = undefined;
                            for (var u = 0; u < r; u++) {
                                var p = this.filters[u].filter;
                                var s = h[this.filters[u].datafield];
                                var o = p.evaluate(s);
                                if (this.grid.filter) {
                                    var y = this.grid.filter(s, h, this.filters[u].datafield, p, o);
                                    if (y !== undefined) {
                                        o = y
                                    }
                                }
                ...
                if (this.sortdata) {
                    if (this.grid && this.grid.sortmode !== "many") {
                        ...
                        if (this.sortcache[e]) {
                            this.sortdata = null;
                            var x = this.sortcache[e].direction;
                            this.sortcache[e] = null;
                            this.sortby(this.sortfield, x);
                            return
                        }
                    } else {
                        ...
                        for (var w = 0; w < d.length; w++) {
                            var n = d[w];
                            var t = n.dataField;
                            this.grid.sortby(t, n.ascending, null)
                        }
                        return
                    }
                }
            ...
            var q = this.reload(this.records, this.rows, this.filter, this.updated, m);
            this.updated = null;
